...
const SocialIcons = () => {
  return (
    <>
      {/* Desktop - Vertical */}
      <div className="fixed left-20 top-1/2 -translate-y-1/2 hidden lg:flex flex-col gap-8 z-40">
        <a 
      ...
      {/* Mobile - Horizontal */}
      <div className="lg:hidden absolute bottom-24 left-1/2 -translate-x-1/2 flex gap-8 z-40">
        <a 
          href="https://instagram.com" 
          target="_blank" 
          rel="noopener noreferrer"
